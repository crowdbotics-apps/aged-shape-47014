"""
Django settings for aged_shape_47014 project.
...
ROOT_URLCONF = 'aged_shape_47014.urls'
...
WSGI_APPLICATION = 'aged_shape_47014.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_shape_47014 API",
    "DESCRIPTION": "API documentation for aged_shape_47014 App",
    "VERSION": "v1",
}
